...
dados_normalized_role  %>% 
  ...
  theme_minimal() + 
  scale_color_brewer(palette = "Set2") +
  ggbeeswarm::geom_quasirandom(shape=16, alpha= 0.5,position=position_jitter(0.3)) + labs(x="",color= "Tipo  de funcionário", y = "Remuneração",       title = "Remunerações por cargos em out de 2020") + 
  coord_flip() + 
