...
incomes <- incomes %>% 
  mutate(
    discounts_others_total = if_else(
      !is.na(discounts_others_total), NA_real_, discounts_others_total
    ),
    funds_gratification = if_else(
     month == 12 | (month == 1 & aid == "trt13"),
     NA_real_, funds_gratification 
    )
  )
