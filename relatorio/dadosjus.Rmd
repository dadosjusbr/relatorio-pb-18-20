...
Na nossa análise mais recente (out/2019), o TRE apresentava um total de **`r n_funcionarios_trepb`**. funcionários e o no TRT13 são **`r n_funcionarios_trt13`**. No MPPB temos **`r n_funcionarios_mppb`**.
...
ggplot(data, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3, fill=category)) +
  geom_rect() +
  geom_text(x=4.9, aes(y=labelPosition, label=label, color=category), size=4) + # x here controls label position (inner / outer)
...
### Gastos com “outros” superam os salários em alguns meses
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
...
```
O salário mediano em 2019 para um sevidor foi de R$ **`r salario_medio_servidor_2019`** . Já para membros foi de R\$ **`r salario_membro_2019`**. Enquanto para pensionistas é de R\$ **`r salario_pensionista_2019`**

### Analista Judiciário recebe 370.603,00 R\$ em maio de 2019
```{r echo = FALSE, message = FALSE, warning = FALSE, cache = FALSE, paged.print = FALSE}
dados_filtrados %>% 
